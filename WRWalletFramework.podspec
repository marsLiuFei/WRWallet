#
#  Be sure to run `pod spec lint WRWalletFramework.podspec' to ensure this is a
...
test WRWalletFramework.
  ...
  # Or just: spec.author    = "GaiShiDaYingXiong"
  # spec.authors            = { "GaiShiDaYingXiong" => "mars_liu_dev@163.com" }
  # spec.social_media_url   = "https://twitter.com/GaiShiDaYingXiong"
  ...
  #spec.source_files = 'WRWalletFramework/*'
  #spec.public_header_files = 'WRWalletFramework/WRWallet.framework/WRWalletManager.h'
  ...
  #
   ...
   spec.resource  = "WRWalletFramework/Resources.bundle"
   spec.ios.vendored_frameworks = 'WRWalletFramework/WRWallet.framework'
