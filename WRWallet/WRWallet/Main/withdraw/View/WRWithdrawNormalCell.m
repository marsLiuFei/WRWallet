...
@interface WRWithdrawNormalCell ()
/** 详情内容 */
...
@end
@implementation WRWithdrawNormalCell
...
- (void)setupUI {
    UILabel *titleLabel = [ViewCreate createLabelFrame:CGRectZero backgroundColor:kClearColor text:@"到账银行卡" textColor:KColor_66 textAlignment:kTextAlignmentLeft font:kFont_R_14];
