...
@interface WRBankCardChangeController ()

@end

@implementation WRBankCardChangeController
...
#pragma mark - 设置UI
- (void)setupUI {
    self.navigationItem.title = @"变更银行卡";
    UILabel *titleLabel = [ViewCreate createLabelFrame:CGRectZero backgroundColor:kClearColor text:@"变更银行卡" textColor:kColor_33 textAlignment:kTextAlignmentCenter font:kFont_21];
...
- (void)gotoSuccessView {
    WRBankCardNewNumberController *cardNewVc = [[WRBankCardNewNumberController alloc] init];
    [self.navigationController pushViewController:cardNewVc animated:true];
}
