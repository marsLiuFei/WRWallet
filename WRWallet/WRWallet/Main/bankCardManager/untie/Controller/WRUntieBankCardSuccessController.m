//
//  WRUntieBankCardSuccessController.m
//  wallet
//
...
@interface WRUntieBankCardSuccessController ()

@end

@implementation WRUntieBankCardSuccessController
...
#pragma mark - 设置UI
- (void)setupUI {
    self.navigationItem.title = @"解绑成功";
    ...
    UILabel *hintLabel = [ViewCreate createLabelFrame:CGRectZero backgroundColor:kClearColor text:@"解除绑定成功" textColor:kColor_33 textAlignment:kTextAlignmentCenter font:kFont_21];
