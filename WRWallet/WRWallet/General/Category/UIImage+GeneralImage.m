...
@implementation UIImage (GeneralImage)
...
+ (UIImage *)singleDotImageWithColor:(UIColor *)color {
...
#pragma mark -- 水印图片
+ (instancetype)waterImageWithBg:(NSString *)bg
                               logo:(NSString *)logo
                              scale:(CGFloat)scale
...
+ (nonnull UIImage *)circleImageWithImage:(nullable UIImage *)sourceImage
    ...
    return [UIImage circleImageWithImage:sourceImage imageSize:imageSizeMin isExistBorder:isExistBorder borderWidth:borderWidth borderColor:borderColor];
}
+ (UIImage *)circleImageWithImageStr:(NSString *)sourceImageStr imageSize:(CGFloat)imageSize isExistBorder:(BOOL)isExistBorder borderWidth:(CGFloat)borderWidth borderColor:(UIColor *)borderColor {
    return [UIImage circleImageWithImage:[UIImage imageNamed:sourceImageStr] imageSize:imageSize isExistBorder:isExistBorder borderWidth:borderWidth borderColor:borderColor];
}
+ (nonnull UIImage *)circleImageWithImage:(nullable UIImage *)sourceImage
